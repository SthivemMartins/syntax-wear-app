...
export const Route = createFileRoute("/_app/products/$productId")({
    ...
    head: ({ params }) => {
        const filteredProduct = products.find(
            (products) => (products.id === Number(params.productId))
        );
...
function RouteComponent() {
    ...
    if (!filteredProduct) return (<section className="container mb-10 pt-44 md:pt-54 pb-10 md:px-10 text-center min-h-[80vh] flex flex-col items-center justify-center">
        <h1 className="text-black text-3xl font-bold mb-4">Produto não encontrado</h1>
    ...
    const discountPrice = originalPrice * 0.9; // Exemplo de desconto de 10%

    const inInstallmentsPrice = originalPrice / 6; // Exemplo de parcelamento em 6 vezes
            ...
            <div className="flex justify-center gap-10">
                ...
                <div className="text-black">
                    ...
                    <p className="text-sm text-[#878787]">
                        Você economina: <span className="font-semibold">10%</span>
                    </p>
